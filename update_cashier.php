        ...
        <div id="content_1" class="content">  
          ...
          <form name="myform" onsubmit="return validateForm(this);" action="update_cashier.php" method="post" >
			<table width="420" height="106" border="0" >	
				...
				<tr><td align="center"><input name="last_name" type="text" style="width:170px" placeholder="Last Name" value="<?php include_once('connect_db.php'); echo $_GET['last_name']?>" id="last_name" /></td></tr>
...
$sql="UPDATE cashier SET first_name='$fname', last_name='$lname', staff_id='$sid',
